...
import { FaClock, FaFacebookF, FaLinkedinIn, FaPhoneAlt, FaYoutube } from "react-icons/fa"
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const response = await fetch(
        `${process.env.NEXT_PUBLIC_API_URL || "http://localhost:1003"}/professionals`,
        {
          method: "POST",
          headers: {
      ...
      setError("Erro ao criar profissional. Por favor, tente novamente.")
    } finally {
      setIsSaving(false)
    }
  }
        ...
        <div className="bg-[#F6F4ED] border-b border-[#E2DED2] px-6 py-4 sticky top-0 z-10">
          <div className="max-w-7xl mx-auto flex justify-between items-center">
            <div>
              ...
              <p className="text-sm text-gray-600 mt-1">Preencha os dados para criar um novo perfil profissional</p>
            </div>
