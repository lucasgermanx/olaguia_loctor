...
export function Footer() {
  return (
    <footer className="bg-teal-800 text-white">
      {/* Share Section */}
      <div className="bg-teal-800 py-6 border-b border-teal-700">
        <div className="container mx-auto px-4 flex flex-col md:flex-row items-center justify-between gap-4">
          ...
          <div className="flex items-center space-x-2">
            ...
            <Link
              ...
              className="w-10 h-10 bg-green-600 hover:bg-green-700 flex items-center justify-center rounded transition-colors"
              target="_blank"
            >
      ...
      {/* Top Info Bar */}
      <div className="border-b border-teal-700 py-4">
        <div className="container mx-auto px-4 flex flex-col md:flex-row items-center justify-between gap-4">
          <div className="flex items-center space-x-2">
            <div className="w-10 h-10 bg-green-600 rounded-full flex items-center justify-center">
              <span className="text-white font-bold text-xl">O</span>
            </div>
            <span className="text-xl font-bold">OLÁGUIA</span>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div>
              ...
              <ul className="space-y-2">
                ...
                <li>
                  <Link href="/franquia" className="text-gray-300 hover:text-white transition-colors text-sm">
                    Franquia
                  </Link>
                </li>
                <li>
            ...
            <div>
              ...
              <ul className="space-y-2">
                ...
                <li>
                  <Link href="/biblioteca" className="text-gray-300 hover:text-white transition-colors text-sm">
                    Biblioteca
                  </Link>
                </li>
                <li>
            ...
            <div className="space-y-6">
              ...
              <div>
                <div className="flex items-center space-x-2 mb-3">
                  ...
                  <h3 className="font-semibold">COMO ANUNCIAR</h3>
                </div>
                <p className="text-sm text-gray-300">
              ...
              {[1, 2, 3].map((item) => (
                <div key={item} className="flex gap-4">
                  ...
                  <div className="flex-1">
                    <h4 className="font-semibold text-sm mb-1 hover:text-green-400 transition-colors">
                      LOREM IPSUM SIT AMET CONSECT
                    </h4>
                    <p className="text-xs text-gray-300 mb-2 line-clamp-2">
                      Lorem ipsum dolor sit amet consectetur adipiscing amet se you
                    </p>
                    <Button className="bg-teal-700 hover:bg-teal-600 text-white text-xs px-3 py-1 h-auto">
                      LEIA MAIS
                    </Button>
                  </div>
                </div>
              ...
              <div className="pt-4 border-t border-teal-700">
                ...
                <Button className="bg-white text-teal-800 hover:bg-gray-100 border border-gray-300 w-full">
                  ENTRAR NO GRUPO
                </Button>
              </div>
            </div>
